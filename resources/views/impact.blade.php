...
<section id="annual-report" class="gsap py-12 md:py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <div class="gsap-card bg-white rounded-xl shadow-md overflow-hidden md:flex">
                <div class="md:w-1/3 bg-green-700 p-6 md:p-8 flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <h3 class="mt-4 text-xl font-bold text-white">2023 Annual Report</h3>
                    </div>
                </div>
                <div class="md:w-2/3 p-6 md:p-8">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Download Our Full Report</h2>
                    <p class="text-gray-600 mb-6">Explore our comprehensive annual report detailing achievements, financials, and future goals for sustainable development in Nepal.</p>
                    <div class="space-y-3">
                        <a href="#" class="flex items-center justify-between bg-gray-100 hover:bg-gray-200 p-3 rounded-lg transition-colors">
                            <div class="flex items-center">
                                <svg class="w-6 h-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                </svg>
                                <span class="font-medium">Full Annual Report (PDF)</span>
                            </div>
                            <span class="text-sm text-gray-500">12MB</span>
                        </a>
                        <a href="#" class="flex items-center justify-between bg-gray-100 hover:bg-gray-200 p-3 rounded-lg transition-colors">
                            <div class="flex items-center">
                                <svg class="w-6 h-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="font-medium">Financial Summary (PDF)</span>
                            </div>
                            <span class="text-sm text-gray-500">3.5MB</span>
                        </a>
                        <a href="#" class="flex items-center justify-between bg-gray-100 hover:bg-gray-200 p-3 rounded-lg transition-colors">
                            <div class="flex items-center">
                                <svg class="w-6 h-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="font-medium">Impact Infographic (JPG)</span>
                            </div>
                            <span class="text-sm text-gray-500">8.2MB</span>
                        </a>
                    </div>
                </div>
            </div>

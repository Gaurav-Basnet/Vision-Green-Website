...
@section('content')
    ...
    <!-- Featured Reports -->
    <section id="publication-archive" class="gsap py-8 md:py-12 bg-gray-50">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="text-center mb-12">
                ...
                @foreach($reports as $report)
                    <div class="gsap-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $report->title }}</h3>
                            <p class="text-gray-600 text-sm mb-4">{{ Str::limit($report->description, 150) }}</p>
                ...
                @forelse($resources as $resource)
                    <div class="gsap-card bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                        <div class="h-40 bg-gray-200 overflow-hidden">
                            <img src="{{ $resource->image ? asset('storage/' . $resource->image) : 'https://via.placeholder.com/400x200' }}"
                                alt="{{ $resource->title }}" class="w-full h-full object-cover">
                        </div>
                        <div class="p-4">
                            <h3 class="font-bold text-gray-800 mb-1">{{ $resource->title }}</h3>
                            <p class="text-gray-600 text-xs mb-3">
                                {{ $resource->grade_level ?? $resource->audience }}
                            </p>
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-xs text-gray-500">
                                    PDF, {{ $resource->file_size ?? 'N/A' }}MB
                                </span>
                            </div>
                        </div>
                    </div>
                @empty
                    <p class="text-gray-600 col-span-4 text-center">No resources available yet.</p>
                @endforelse
            </div>

...
@section('title', 'Publicaton Page Editor')
@section('content')
    ...
    <form action="{{ route('publication-sections.update') }}" method="POST">
        @csrf
        <!-- Hero Section -->
        <section id="reports"
            ...
            <div class="container mx-auto px-4 text-center relative z-10">
                <input type="text" name="t1" value="{{ old('t1', $homedata->t1) }}" placeholder="Enter Main Heading"
                ...
                <!-- <p class="text-lg md:text-xl max-w-2xl mx-auto">Research, reports, and resources for environmental conservation in Nepal</p> -->
                <input type="text" name="st1" value="{{ old('st1', $homedata->st1) }}" placeholder="Enter Subheading"
        ...
        <section id="policy-briefs" class="gsap py-8 md:py-12 bg-white">
            <div class="container mx-auto px-4 max-w-6xl">
                <div class="text-center mb-12">
                    <input type="text" name="t2" value="{{ old('t2', $homedata->t2) }}" placeholder="Enter Main Heading"
                        class="text-2xl md:text-3xl font-bold text-green-800 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">
                    <input type="text" name="st2" value="{{ old('st2', $homedata->st2) }}" placeholder="Enter Subheading"
                        class="text-gray-600 mt-2 max-w-3xl mx-auto w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="gsap-card bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
                        ...
                        <input type="text" name="t3" value="{{ old('t3', $homedata->t3) }}" placeholder="Enter Card Title"
                            class="text-xl font-bold mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                        <textarea name="st3" placeholder="Enter Card Text"
                            class="text-gray-700 text-sm w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st3', $homedata->st3) }}</textarea>
                    ...
                    <div class="gsap-card bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
                        ...
                        <input type="text" name="t4" value="{{ old('t4', $homedata->t4) }}"
                            placeholder="Enter Card Title"
                            class="text-xl font-bold mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                        <textarea name="st4" placeholder="Enter Card Text"
                            class="text-gray-700 text-sm w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st4', $homedata->st4) }}</textarea>
                    ...
                    <div class="gsap-card bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
                        ...
                        <input type="text" name="t5" value="{{ old('t5', $homedata->t5) }}"
                            placeholder="Enter Card Title"
                            class="text-xl font-bold mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                        <textarea name="st5" placeholder="Enter Card Text"
                            class="text-gray-700 text-sm w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st5', $homedata->st5) }}</textarea>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4 max-w-6xl">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="gsap-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-2">
                                <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded">2023
                                    Report</span>
                            ...
                            <p class="text-gray-600 text-sm mb-4">Comprehensive analysis of biodiversity trends across the
                                Nepalese Himalayas with conservation recommendations.</p>
                    ...
                    <div class="gsap-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-2">
                                <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded">2022
                                    Report</span>
                                <span class="text-xs text-gray-500">March 8, 2022</span>
                            </div>
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Climate Change Impacts on Nepalese Agriculture
                            </h3>
                            <p class="text-gray-600 text-sm mb-4">Case studies from 15 districts documenting climate impacts
                                and community adaptation strategies.</p>
                            <div class="flex justify-between items-center">
                                <a href="#"
                                    class="text-green-600 hover:text-green-700 text-sm font-medium flex items-center">
                                    Download PDF
        ...
        <section id="policy-briefs" class="gsap py-8 md:py-12 bg-white">
            <div class="container mx-auto px-4 max-w-6xl">
                <div class="text-center mb-12">
                    <input type="text" name="t6" value="{{ old('t6', $homedata->t6) }}" placeholder="Enter Main Heading"
                        class="text-2xl md:text-3xl font-bold text-green-800 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">
                    <input type="text" name="st6" value="{{ old('st6', $homedata->st6) }}" placeholder="Enter Subheading"
                        class="text-gray-600 mt-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">
                </div>

                <div class="grid md:grid-cols-3 gap-6">
                    <!-- Brief 1 -->
                    <div
                        class="gsap-card bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                        <div class="p-5">
                            <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded">Policy
                                Brief</span>
                            <input type="text" name="t7" value="{{ old('t7', $homedata->t7) }}"
                                placeholder="Enter Brief Title"
                                class="text-lg font-bold text-gray-800 mt-3 mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                            <textarea name="st7" placeholder="Enter Brief Description"
                                class="text-gray-600 text-sm mb-4 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st7', $homedata->st7) }}</textarea>
                    ...
                    <div
                        ...
                        <div class="p-5">
                            <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded">Policy
                                Brief</span>
                            <input type="text" name="t8" value="{{ old('t8', $homedata->t8) }}"
                                placeholder="Enter Brief Title"
                                class="text-lg font-bold text-gray-800 mt-3 mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                            <textarea name="st8" placeholder="Enter Brief Description"
                                class="text-gray-600 text-sm mb-4 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st8', $homedata->st8) }}</textarea>
                            <a href="#" class="text-green-600 hover:text-green-700 text-sm font-medium flex items-center">
                                Read Brief
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded">Policy
                                Brief</span>
                            <input type="text" name="t9" value="{{ old('t9', $homedata->t9) }}"
                                placeholder="Enter Brief Title"
                                class="text-lg font-bold text-gray-800 mt-3 mb-2 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">
                            <textarea name="st9" placeholder="Enter Brief Description"
                                class="text-gray-600 text-sm mb-4 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg">{{ old('st9', $homedata->st9) }}</textarea>
                            <a href="#" class="text-green-600 hover:text-green-700 text-sm font-medium flex items-center">
                                Read Brief
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            <select
                                class="bg-white border border-gray-300 text-gray-700 py-2 px-3 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-green-500">
                        ...
                        <div class="gsap-card py-4 hover:bg-white transition-colors duration-150">
                            <div class="flex flex-col md:flex-row md:items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    <span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">Research
                                        Report</span>
                    ...
                    <div class="mt-6 flex justify-center">
                        <nav class="inline-flex rounded-md shadow">
                            <a href="#"
                                class="px-3 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">Previous</a>
                            <a href="#"
                                class="px-3 py-2 border-t border-b border-gray-300 bg-white text-sm font-medium text-green-600 hover:bg-gray-50">1</a>
                            <a href="#"
                                class="px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">2</a>
                            <a href="#"
                                class="px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">3</a>
                            <a href="#"
        ...
        <section id="cta-section" class=" py-8 md:py-12 bg-green-700 text-white gsap">
            <div class="container mx-auto px-4 text-center">
                <!-- <h2 class="text-2xl md:text-3xl font-bold mb-4">Stay Updated With Our Research</h2>
                                    <p class="max-w-2xl mx-auto mb-8">Subscribe to receive notifications about new publications and research findings.</p> -->
                <input type="text" name="t9" value="{{ old('t9', $homedata->t9) }}" placeholder="Enter Section Heading"
                    class="text-2xl md:text-3xl font-bold mb-4 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">

                <textarea name="st10" placeholder="Enter Section Description"
                    class="max-w-2xl mx-auto mb-8 w-full bg-transparent border-2 border-dashed border-gray-400 focus:outline-none focus:border-blue-500 p-2 rounded-lg flex text-center">{{ old('st10', $homedata->st10) }}</textarea>
                <div class="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
                    <input type="email" placeholder="Your email address"
                        class="flex-grow px-4 py-2 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-300">
                    <button
                        class="bg-white text-green-700 hover:bg-gray-100 px-6 py-2 rounded-md font-medium transition-colors">
                        Subscribe
                    </button>
                </div>
            </div>
